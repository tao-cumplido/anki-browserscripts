// these are copied from typescript's lib.dom.d.ts and lib.dom.iterable.d.ts, only exported as a module instead of declared globally
...
export var AuthenticatorAssertionResponse: {
...
export var AuthenticatorAttestationResponse: {
...
export var AuthenticatorResponse: {
...
export var CredentialsContainer: {
...
export interface DocumentAndElementEventHandlers {
	...
	addEventListener<K extends keyof DocumentAndElementEventHandlersEventMap>(
		type: K,
		listener: (this: DocumentAndElementEventHandlers, ev: DocumentAndElementEventHandlersEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export interface HTMLTableDataCellElement extends HTMLTableCellElement {
	addEventListener<K extends keyof HTMLElementEventMap>(
		type: K,
		listener: (this: HTMLTableDataCellElement, ev: HTMLElementEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export interface HTMLTableHeaderCellElement extends HTMLTableCellElement {
	...
	addEventListener<K extends keyof HTMLElementEventMap>(
		type: K,
		listener: (this: HTMLTableHeaderCellElement, ev: HTMLElementEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export var OffscreenCanvasRenderingContext2D: {
...
export var OverconstrainedError: {
...
export var PublicKeyCredential: {
...
export interface RTCSrtpSdesTransport extends EventTarget {
	...
	addEventListener<K extends keyof RTCSrtpSdesTransportEventMap>(
		type: K,
		listener: (this: RTCSrtpSdesTransport, ev: RTCSrtpSdesTransportEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export interface RandomSource {
	getRandomValues<
		T extends Int8Array | Uint8ClampedArray | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array
	>(
		array: T,
	): T;
}
...
export interface SVGAnimateTransformElement extends SVGAnimationElement {
	addEventListener<K extends keyof SVGElementEventMap>(
		type: K,
		listener: (this: SVGAnimateTransformElement, ev: SVGElementEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export var SVGFEDropShadowElement: {
...
export var WebGL2RenderingContext: {
...
export var WebGLTransformFeedback: {
...
export var WebGLVertexArrayObject: {
...
export interface webkitRTCPeerConnection extends RTCPeerConnection {
	addEventListener<K extends keyof RTCPeerConnectionEventMap>(
		type: K,
		listener: (this: webkitRTCPeerConnection, ev: RTCPeerConnectionEventMap[K]) => any,
		options?: boolean | AddEventListenerOptions,
	): void;
	addEventListener(
		type: string,
...
export var ondeviceorientationabsolute: ((this: Window, ev: DeviceOrientationEvent) => any) | null;
...
export var onreadystatechange: ((this: Window, ev: ProgressEvent<Window>) => any) | null;
...
export var visualViewport: VisualViewport;
...
export var onauxclick: ((this: Window, ev: MouseEvent) => any) | null;
/**
 * Fires when the object loses the input focus.
 * @param ev The focus event.
 */
 ...
 * @param ev The event.
 */
export var onerror: OnErrorEventHandler;
/**
 * Fires when the object receives focus.
 * @param ev The event.
 */
 ...
 * @param ev The event.
 */
export var onscroll: ((this: Window, ev: Event) => any) | null;
 ...
 * @param ev The event.
 */
export var onselect: ((this: Window, ev: Event) => any) | null;
export var onselectionchange: ((this: Window, ev: Event) => any) | null;
export var onselectstart: ((this: Window, ev: Event) => any) | null;
/**
 * Occurs when the download has stopped.
 * @param ev The event.
 */
...
export var ontouchcancel: ((this: Window, ev: TouchEvent) => any) | null | undefined;
export var ontouchend: ((this: Window, ev: TouchEvent) => any) | null | undefined;
export var ontouchmove: ((this: Window, ev: TouchEvent) => any) | null | undefined;
export var ontouchstart: ((this: Window, ev: TouchEvent) => any) | null | undefined;
...
export var onrejectionhandled: ((this: Window, ev: PromiseRejectionEvent) => any) | null;
...
export type ClientTypes = 'all' | 'sharedworker' | 'window' | 'worker';
...
export type DisplayCaptureSurfaceType = 'application' | 'browser' | 'monitor' | 'window';
...
export type LineAlignSetting = 'center' | 'end' | 'start';
export type ListeningState = 'active' | 'disambiguation' | 'inactive';
export type MSCredentialType = 'FIDO_2_0';
export type MSTransportType = 'BT' | 'Embedded' | 'NFC' | 'USB';
export type MSWebViewPermissionState = 'allow' | 'defer' | 'deny' | 'unknown';
export type MSWebViewPermissionType =
	| 'geolocation'
	| 'media'
	| 'pointerlock'
...
export type MediaKeyMessageType =
...
export type NavigationReason = 'down' | 'left' | 'right' | 'up';
export type NavigationType = 'back_forward' | 'navigate' | 'prerender' | 'reload';
...
export type OrientationLockType =
	...
	| 'portrait-primary'
	| 'portrait-secondary';
export type OrientationType = 'landscape-primary' | 'landscape-secondary' | 'portrait-primary' | 'portrait-secondary';
...
export type PaymentShippingType = 'delivery' | 'pickup' | 'shipping';
...
export type PositionAlignSetting = 'auto' | 'center' | 'line-left' | 'line-right';
...
export type RTCDegradationPreference = 'balanced' | 'maintain-framerate' | 'maintain-resolution';
...
export type RTCIceRole = 'controlled' | 'controlling' | 'unknown';
...
export type RTCSctpTransportState = 'closed' | 'connected' | 'connecting';
...
export type RTCSignalingState =
	...
	| 'stable';
export type RTCStatsIceCandidatePairState = 'cancelled' | 'failed' | 'frozen' | 'inprogress' | 'succeeded' | 'waiting';
export type RTCStatsIceCandidateType = 'host' | 'peerreflexive' | 'relayed' | 'serverreflexive';
...
export type Transport = 'ble' | 'nfc' | 'usb';
...
export type VideoFacingModeEnum = 'environment' | 'left' | 'right' | 'user';
