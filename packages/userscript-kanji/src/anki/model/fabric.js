...
// built from http://fabricjs.com/build/
// - Free Drawing
// - Interaction
// - Remove SVG import
// - Remove SVG export
      ...
      /** @lends fabric.Canvas.prototype */ {
         ...
         _setObjectSkew: function (localMouse, transform, by, _dim) {
            ...
            if (newDimMouse <= 2) {
               ...
               newValue =
                  skewSign *
                  Math.atan(newDimMouse / target['scale' + _by] / (dimNoSkew[otherBy] / target['scale' + _otherBy]));
   ...
   fabric.util.object.extend(
      ...
      /** @lends fabric.Canvas.prototype */ {
         ...
         __onMouseDown: function (e) {
            ...
            if (
               this.selection &&
               (!target || (!target.selectable && !target.isEditing && target !== this._activeObject))
            ) {
               this._groupSelector = {
                  ex: pointer.x,
                  ey: pointer.y,
      ...
      /** @lends fabric.Canvas.prototype */ {
         ...
         _collectObjects: function (e) {
            ...
            for (var i = this._objects.length; i--; ) {
               ...
               if (
                  (allowIntersect && currentObject.intersectsWithRect(selectionX1Y1, selectionX2Y2)) ||
   ...
   fabric.Object = fabric.util.createClass(
      ...
      /** @lends fabric.Object.prototype */ {
         ...
         isNotVisible: function () {
            return (
               this.opacity === 0 || (this.width === 0 && this.height === 0 && this.strokeWidth === 0) || !this.visible
            );
         },
         ...
         _renderControls: function (ctx, styleOverride) {
            ...
            drawControls =
               typeof styleOverride.hasControls !== 'undefined' ? styleOverride.hasControls : this.hasControls;
         ...
         _setShadow: function (ctx) {
            ...
            ctx.shadowColor = shadow.color;
            ctx.shadowBlur =
               (shadow.blur * fabric.browserShadowBlurConstant * (multX + multY) * (scaling.scaleX + scaling.scaleY)) /
               4;
   ...
   fabric.util.object.extend(
      ...
      /** @lends fabric.Object.prototype */ {
         ...
         containsPoint: function (point, lines, absolute, calculate) {
            var lines =
                  lines ||
                  this._getImageLines(calculate ? this.calcCoords(absolute) : absolute ? this.aCoords : this.oCoords),
      ...
      /** @lends fabric.Object.prototype */ {
         ...
         drawBordersInGroup: function (ctx, options, styleOverride) {
            ...
            var p = { x: this.width, y: this.height },
               ...
               width =
                  wh.x +
                  strokeWidth * (this.strokeUniform ? this.canvas.getZoom() : options.scaleX) +
                  borderScaleFactor,
               height =
                  wh.y +
                  strokeWidth * (this.strokeUniform ? this.canvas.getZoom() : options.scaleY) +
                  borderScaleFactor;
            ctx.save();
            this._setLineDash(ctx, styleOverride.borderDashArray || this.borderDashArray, null);
            ctx.strokeStyle = styleOverride.borderColor || this.borderColor;
